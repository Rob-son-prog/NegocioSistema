    ...
    return `
      <div class="order-card" data-id="${o.id}">
        ...
        <div class="order-actions">
          <button class="btn sm primary" data-approve="${o.id}" data-product="${attr(prod)}">Aprovar</button>
          <button class="btn sm danger"  data-reject="${o.id}"  data-product="${attr(prod)}">Recusar</button>
        </div>
      </div>
    `;
  }
