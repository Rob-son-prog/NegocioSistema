...
function renderOrderAlert(orders = []) {
  ...
  // escolhe o mais recente por qualquer timestamp disponível
  ...
  let cor = '#f59e0b'; // aguardando (âmbar)
...
function render(data){
  ...
  // Link do botão "Fazer novo pedido" levando o contexto
...
// --- tempo real: escuta decisões da tela de aprovações
