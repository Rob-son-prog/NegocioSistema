...
// --- SOMA dos recebidos no mês (parcelas pagas no mês) -----------------
...
export function sumReceivedCurrentMonth() {
  const now = new Date();
  return sumReceivedForMonth(now.getFullYear(), now.getMonth() + 1);
}

// --- marcar parcela paga: garante paid_at no formato YYYY-MM-DD --------
export function markInstallmentPaid(id) {
