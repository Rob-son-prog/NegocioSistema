  ...
  try {
    ...
    bc.onmessage = (ev) => {
      ...
      if (msg?.type === 'order_decided') {
        ...
        loadOrderAlerts();  // sincroniza com backend
      }
    };
  } catch {}
...
// ---- Polling contínuo (a cada 2s enquanto houver pending; 30s de segurança)
let fastTimer = null;
